...
import { semesterStats } from "@/data/syllabusData";

export const SemesterOverview = () => {
  return (
      ...
      <Card className="p-6 bg-gradient-to-br from-primary/20 to-primary/5 border-primary/20">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-4xl font-bold text-foreground">{semesterStats.totalCourses}</p>
          </div>
      ...
      <Card className="p-6 bg-gradient-to-br from-secondary/20 to-secondary/5 border-secondary/20">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-4xl font-bold text-foreground">{semesterStats.totalCredits}</p>
          </div>
      ...
      <Card className="p-6 bg-gradient-to-br from-accent/20 to-accent/5 border-accent/20">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-4xl font-bold text-foreground">{semesterStats.averageContactHours}</p>
          </div>
